...
export class MatchApi {
  ...
  static findManyByWinnerId(
    ...
    return HttpService.api.get(
      `/v1/teams/winner/${winnerId}/matchs${buildOptions}`,
    )
  }

  static createOneByWinnerId(
    winnerId: string,
    values: Partial<Match>,
  ): Promise<Match> {
    return HttpService.api.post(`/v1/teams/winner/${winnerId}/matchs`, values)
  }
}
